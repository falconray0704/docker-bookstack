BOOKSTACK_RELEASE_VERSION := "22.10.2"
DOCKER_RELEASE_REG=rayruan
DOCKER_IMAGE=bookstack_apache
...
VCS_URL := https://github.com/rayruan/docker-bookstack
...
release:
	docker tag $(DOCKER_RELEASE_REG)/$(DOCKER_IMAGE_DEV):$(DOCKER_INTERNAL_TAG) $(DOCKER_RELEASE_REG)/$(DOCKER_IMAGE):${BOOKSTACK_RELEASE_VERSION}
...
push-release:
	docker push $(DOCKER_RELEASE_REG)/$(DOCKER_IMAGE):$(BOOKSTACK_RELEASE_VERSION)
